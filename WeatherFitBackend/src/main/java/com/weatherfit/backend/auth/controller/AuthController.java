    ...
    public class AuthController {
        ...
        public ResponseEntity<Map<String, String>> findUsername(@RequestBody FindUsernameRequestDto requestDto) {
            String username = authService.findUsername(requestDto.getEmail(), requestDto.getPassword());
